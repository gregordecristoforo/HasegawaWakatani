...
_, convergence1 = test_resolution_convergence(prob, quadratic_function, analytical_solution, resolutions, MSS1())
_, convergence2 = test_resolution_convergence(prob, quadratic_function, analytical_solution, resolutions, MSS2())
_, convergence3 = test_resolution_convergence(prob, quadratic_function, analytical_solution, resolutions, MSS3())
